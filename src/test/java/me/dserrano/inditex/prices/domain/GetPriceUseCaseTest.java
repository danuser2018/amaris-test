...
public class GetPriceUseCaseTest {
    ...
    public void validParametersReturnsAPrice() {
        ...
        // When
        Optional<Price> result = classToTest.get(date, productId, brandId);
    ...
    public void validRequestForTwoPricesReturnsTheOneWithMostPriority() {
        // Given
        when(locatePricesPort.get(date, productId, brandId)).thenReturn(List.of(PRICE_1, PRICE_2));
    ...
    public void validRequestReturnsNoPrice() {
        // Given
        when(locatePricesPort.get(date, productId, brandId)).thenReturn(List.of());
